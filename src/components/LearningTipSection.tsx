    ...
    <section className="py-16">
      <div className="container">
        <div className="glass-card overflow-hidden">
          <div className="flex flex-col items-center gap-6 p-8 text-center md:flex-row md:text-left" dir="ltr">
            ...
            <div className="flex-1">
              <h3 className="mb-3 text-xl font-bold text-foreground text-left">
                Lerntipp der Warizmy Akademie
              </h3>
              <p className="mb-3 leading-relaxed text-foreground text-left">
              ...
              <p className="font-arabic-display text-sm text-muted-foreground text-right" dir="rtl">
