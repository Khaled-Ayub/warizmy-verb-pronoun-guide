...
const separatePronouns = [
  ...
  { person: "2. Du", arabic: "أنتُما", german: "ihr beide", emoji: "👫", description: "Anrede an zwei Personen" },
  ...
  { person: "3. Du m", arabic: "هُما", german: "sie beide (m)", emoji: "👬", description: "Dritte Person dual männlich/gemischt" },
  { person: "3. Du w", arabic: "هُما", german: "sie beide (w)", emoji: "👭", description: "Dritte Person dual weiblich" },
...
const attachedPronouns = [
  ...
  {
    suffix: "ـكُما",
    verbExample: "كَتَبَكُما",
    nounExample: "كِتابُكُما",
    german: "euch beiden / euer (dual)",
    emoji: "👫",
    description: "2. Person Dual. Wird für zwei Personen verwendet (Objekt oder Besitz).",
  },
  {
    suffix: "ـهُ",
  ...
  {
    suffix: "ـهما",
    verbExample: "كَتَبَهُما",
    nounExample: "كِتابُهُما",
    german: "sie beide / ihr (dual)",
    emoji: "👬",
    description: "3. Person Dual. Am Verb: 'sie beide', am Nomen: 'ihr beider'.",
  },
  {
    suffix: "ـنا",
